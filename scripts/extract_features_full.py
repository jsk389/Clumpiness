...
from clumpiness.featureextractor import FeatureExtractor, Preprocessing
from clumpiness.Dataset_regular import Dataset
from clumpiness.features import Features
from clumpiness.config import readConfigFile
